...
class SearchServiceTest {
    ...
    void 파티_검색_성공() {
        ...
        assertThat(partyPage.getPartyList().get(0).getPartyId()).isEqualTo(party4.getId());
        assertThat(partyPage.getPartyList().get(1).getPartyId()).isEqualTo(party2.getId());
        ...
        assertThat(partyPage1.getPartyList().get(0).getPartyId()).isEqualTo(party3.getId());
        assertThat(partyPage1.getPartyList().get(1).getPartyId()).isEqualTo(party1.getId());
