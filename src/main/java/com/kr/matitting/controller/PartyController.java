...
public class PartyController {
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "801", description = "올바르지 못한 REQUEST 값.", content = @Content(schema = @Schema(implementation = PartyExceptionType.class)))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "600", description = "회원 정보가 없습니다.", content = @Content(schema = @Schema(implementation = UserExceptionType.class))),
        @ApiResponse(responseCode = "700", description = "참가 신청 정보가 없습니다.", content = @Content(schema = @Schema(implementation = PartyJoinExceptionType.class))),
        @ApiResponse(responseCode = "800", description = "파티 정보가 없습니다.", content = @Content(schema = @Schema(implementation = PartyExceptionType.class)))
    })
